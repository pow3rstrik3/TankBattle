...
public class NPCTankController : AdvancedFSM 
{
    ...
    protected override void Initialize()
    {
        ...
        friendlies = GameObject.FindGameObjectsWithTag("Enemy");
    ...
    private void ConstructFSM()
    {
        ...
        patrol.AddTransition(Transition.inDanger, FSMStateID.Fleeing);
        patrol.AddTransition(Transition.toCloseToFriendly, FSMStateID.Evading);
        ...
        chase.AddTransition(Transition.toCloseToFriendly, FSMStateID.Evading);
        chase.AddTransition(Transition.NoHealth, FSMStateID.Dead);

        AttackState attack = new AttackState(waypoints);
        attack.AddTransition(Transition.LostPlayer, FSMStateID.Patrolling);
        attack.AddTransition(Transition.SawPlayer, FSMStateID.Chasing);
        attack.AddTransition(Transition.inDanger, FSMStateID.Fleeing);
        attack.AddTransition(Transition.toCloseToFriendly, FSMStateID.Evading);
        attack.AddTransition(Transition.NoHealth, FSMStateID.Dead);

        FleeingState flee = new FleeingState(waypoints);
        flee.AddTransition(Transition.LostPlayer, FSMStateID.Patrolling);
        flee.AddTransition(Transition.SawPlayer, FSMStateID.Chasing);
        flee.AddTransition(Transition.toCloseToFriendly, FSMStateID.Evading);
        flee.AddTransition(Transition.NoHealth, FSMStateID.Dead);

        EvadeState evade = new EvadeState(waypoints);
        ...
        evade.AddTransition(Transition.inDanger, FSMStateID.Fleeing);
    ...
    public bool isTooCloseToFriendly()
    {
        if (friendlies.Length > 0)
        {
            foreach (GameObject friendly in friendlies)
            {
                ...
                return distanceToFriendly < 100.0f;
            }
        }
